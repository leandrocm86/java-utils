...
//		Lista<String> inteiros = new Lista<String>();
//		inteiros.add("0");
//		inteiros.add("1");
//		inteiros.add("2");
//		inteiros.add("3");
//		inteiros.add("4");
//		inteiros.add("5");
//		assertEquals(2.5, inteiros.extrairMedia(inteiro -> Integer.parseInt(inteiro)), 0);
//		assertEquals(3, inteiros.extrairMediaRedonda(inteiro -> Integer.parseInt(inteiro)));
//	}
//	
